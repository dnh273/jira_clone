...
import { UserOutlined, LockOutlined, FacebookOutlined, TwitterOutlined,MailOutlined } from '@ant-design/icons';
    ...
    return (
        <form onSubmit={handleSubmit} className="container" style={{ height: window.innerHeight }} >
            <div className="d-flex flex-column justify-content-center align-items-center" style={{ height: window.innerHeight }} >
                <h3 className="text-center" style={{ fontWeight: 600, fontSize: 30 }}>LOGIN CYBERBUG</h3>
                ...
                <div className='pt-3'>
                    ...
                    <NavLink activeClassName='' activeStyle={{}} style={{fontWeight: 'bold'}} to="/signupcyberbug"> Sign Up</NavLink>
                        </p>
                </div>
